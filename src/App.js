...
const tld = '.Thing';
const CONTRACT_ADDRESS = '0x250FC4fBa9641147b08E0446cD93c34e825784f2';
	...
	return (
		<div className="App">
			...
			<div className="header-container">
				<header>
					<div className="left">
						<p className="title">Thingy Thing Name Service</p>
						<p className="subtitle">the most Thingy Thing around blockchain</p>
					</div>
